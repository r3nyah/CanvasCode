          ...
          children: [
            ...
            Row(
              children: [
                ...
                Slider(value: strokeSize.value,min:0,max:50,onChanged: (val){
                  //                Slider(value: strokeSize.value,min:0,max:50,onChanged: (val){
            ...
            Row(
              children: [
                ...
                Slider(value: eraserSize.value,min:0,max:80,onChanged: (val){
                  //                Slider(value: eraserSize.value,min:0,max:80,onChanged: (val){
              ...
              children: [
                TextButton(
                  onPressed: allSketches.value.isNotEmpty
                    ? (){
                    return undoRedoStack.value.undo();
                  }:null,
                ...
                ValueListenableBuilder<bool>(
                  ...
                  builder: (_, canRedo, __){
                    return TextButton(
                      onPressed: canRedo
                        ? (){
                        return undoRedoStack.value.redo();
                      }:null,
                ...
                TextButton(
                  ...
                  onPressed: (){
                    return undoRedoStack.value.clear();
                  },
                ),
                TextButton(
                  onPressed: () async{
                ...
                /*TextButton(
                  ...
                  onPressed: () => _launchUrl(kGithubRep),
                )*/
              ],
            ),
            const SizedBox(height: 20,),
    ...
    if(!kIsWeb && !Platform.isAndroid && !Platform.isIOS){
      ...
      if(file != null){
        ...
        if(bytes != null){
          ...
          completer.completeError('No image attached');
        }
      }
    }else{
...
class _IconBox extends StatelessWidget {
  ...
  const _IconBox({
    ...
    this.iconData,
    this.tooltip,
  }) : assert(child != null || iconData != null),super(key: key);
